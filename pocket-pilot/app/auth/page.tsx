    ...
    <main className="min-h-screen bg-[var(--canvas)] lg:grid lg:grid-cols-[minmax(0,1fr)_minmax(480px,0.78fr)]">
      <section className="auth-showcase hidden min-h-screen p-12 text-white lg:flex lg:flex-col lg:justify-between xl:p-16">
        ...
        <div className="max-w-2xl">
          <p className="mb-4 text-xs font-extrabold uppercase tracking-[0.16em] text-[#cfc6ad]">Planification financière</p>
          ...
          <p className="mt-5 max-w-xl text-base leading-7 text-[#ddd3ba]">Revenus, charges, budgets et objectifs réunis dans une vue claire.</p>
        ...
        <p className="max-w-lg border-l-2 border-[#8fae94] pl-4 text-sm leading-6 text-[#cfc6ad]">Pas de complexité bancaire. Des calculs déterministes, centrés sur tes projets.</p>
      </section>
