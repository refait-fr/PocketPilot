  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-6xl">
        ...
        <div className="mt-10 grid gap-6 xl:grid-cols-[minmax(320px,0.78fr)_minmax(0,1.22fr)]">
          <div className="h-[42rem] rounded-[1.75rem] bg-[var(--paper)] motion-safe:animate-pulse" />
          <div className="h-96 rounded-[1.75rem] bg-[var(--paper)] motion-safe:animate-pulse" />
        </div>
        <p className="sr-only">Chargement des objectifs d’épargne…</p>
      </div>
    </main>
  );
}
