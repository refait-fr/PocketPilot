...
values
  ('11111111-1111-1111-1111-111111111111', 'Token A', 'hash-a'),
  ('22222222-2222-2222-2222-222222222222', 'Token B', 'hash-b');
...
select results_eq(
  $$select count(*) from public.api_tokens where user_id = '11111111-1111-1111-1111-111111111111'$$,
  array[1::bigint],
  'A can read their own api token'
);
...
select is_empty(
  $$select user_id from public.api_tokens where user_id = '22222222-2222-2222-2222-222222222222'$$,
  'A cannot read B api token'
);
...
select is_empty(
  $$update public.api_tokens set name = 'Changed' where user_id = '22222222-2222-2222-2222-222222222222' returning user_id$$,
  'A cannot update B api token'
);
...
select is_empty(
  $$delete from public.api_tokens where user_id = '22222222-2222-2222-2222-222222222222' returning user_id$$,
  'A cannot delete B api token'
);
...
select throws_ok(
  $$insert into public.api_tokens (user_id, name, token_hash) values ('22222222-2222-2222-2222-222222222222', 'Injected token', 'hash-injected')$$,
  '42501',
  null,
  'A cannot create an api token owned by B'
);
select throws_ok(
...
select results_eq($$select count(*) from public.api_tokens where user_id = '11111111-1111-1111-1111-111111111111'$$, array[0::bigint], 'A api tokens are cascaded');
